...
namespace RawDiskCopier
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            {
                MessageBox.Show("This program requires execution privileges", "Raw Disk Copier");
                return;
            }
            ...
            if (!isAdministrator)
            {
                MessageBox.Show("This program requires administrator privileges!", "Raw Disk Copier");
                return;
            }
