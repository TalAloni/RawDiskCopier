...
namespace RawDiskCopier
{
    public class DiskReader
    {
        ...
        private long m_numberOfUnrecoveredSectors;

        public delegate void UpdateStatusHandler(long currentPosition, long numberOfUnrecoveredSectors);
        ...
        public byte[] ReadEverySectorUnbuffered(long sectorIndex, int sectorCount, out List<long> damagedSectors, out bool ioErrorOccured)
        {
            ...
            catch (IOException ex1)
            {
                ...
                // Note: Sometimes the bulk read will raise an exception but all sector by sector reads will succeed.
        ...
        protected void UpdateStatus(long position)
        {
            ...
            {
                OnStatusUpdate(position, m_numberOfUnrecoveredSectors);
            }
        }
        ...
        public long NumberOfUnrecoveredSectors
        {
            get
            {
                return m_numberOfUnrecoveredSectors;
            }
        }
    }
}
